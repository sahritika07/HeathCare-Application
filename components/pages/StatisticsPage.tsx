...
export default function StatisticsPage({ healthData }: StatisticsPageProps) {
  ...
  return (
    <div className="p-4 sm:p-6 overflow-auto">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-blue-800">Statistics</h1>
        <p className="text-gray-500 text-sm sm:text-base">Track your health metrics and progress over time</p>
      </div>
      ...
      {/* Chart Section: Water & Monthly Trends */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Weekly Water Intake</h2>
          <div className="h-64">
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4">Monthly Trends</h2>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500">Weekly Avg Steps</h3>
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500">Weekly Avg Water</h3>
          <p className="text-xl font-bold text-gray-900 mt-2">
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500">Weekly Avg Sleep</h3>
          <p className="text-xl font-bold text-gray-900 mt-2">
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500">Weekly Avg Calories</h3>
          <p className="text-xl font-bold text-gray-900 mt-2">
